...
function render4(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  })], 16, _hoisted_24)), [[_directive_ripple]]) : createCommentVNode("", true), createBaseVNode("div", mergeProps({
  ...
  })], 16, _hoisted_5)), [[_directive_ripple]]) : createCommentVNode("", true)], 16, _hoisted_14), $options.totalIndicators >= 0 && _ctx.showIndicators ? (openBlock(), createElementBlock("ul", mergeProps({
    key: 0,
