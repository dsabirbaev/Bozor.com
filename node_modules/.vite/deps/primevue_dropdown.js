...
var _hoisted_15 = ["id"];
var _hoisted_24 = ["id", "value", "placeholder", "tabindex", "disabled", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant"];
var _hoisted_33 = ["id", "tabindex", "aria-label", "aria-labelledby", "aria-expanded", "aria-controls", "aria-activedescendant", "aria-disabled"];
var _hoisted_43 = ["value", "placeholder", "aria-owns", "aria-activedescendant"];
var _hoisted_53 = ["id"];
var _hoisted_63 = ["id"];
...
function render6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  })], 16, _hoisted_33)), _ctx.showClear && _ctx.modelValue != null ? renderSlot(_ctx.$slots, "clearicon", {
    key: 2,
    ...
    "default": withCtx(function() {
      return [createVNode(Transition, mergeProps({
        ...
        "default": withCtx(function() {
          return [$data.overlayVisible ? (openBlock(), createElementBlock("div", mergeProps({
          ...
          }, _objectSpread2(_objectSpread2({}, _ctx.filterInputProps), _ctx.ptm("filterInput"))), null, 16, _hoisted_43), renderSlot(_ctx.$slots, "filtericon", {
            ...
            content: withCtx(function(_ref) {
              ...
              return [createBaseVNode("ul", mergeProps({
                ...
                })], 16, _hoisted_63)) : withDirectives((openBlock(), createElementBlock("li", mergeProps({
                  key: 1,
                  id: $data.id + "_" + $options.getOptionIndex(i, getItemOptions),
                  "class": _ctx.cx("item", {
                    option,
              ...
              })], 16)) : createCommentVNode("", true)], 16, _hoisted_53)];
            }),
            _: 2
          }, [_ctx.$slots.loader ? {
            name: "loader",
